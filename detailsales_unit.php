...
$contents = Data_sale::sum_all_with_date_range_in_shop($sumColumns,"2015/08/01", "2015/08/31", "00");
// 検索押された
if(isset($search)){
//    $contents = Data_sale::sum_all_with_date_range_in_shop($sumColumns, $dateFrom, $dateTo, $searchIn);
    foreach($POST["searchIn"] as $shopid) {
        $contents[] = Data_sale::sum_all_with_date_range_in_shop($sumColumns, $dateFrom, $dateTo, $shopid);
    }
}
    ...
    <div class="pageContent">
        ...
        <div class="main">
            ...
            <div style="clear: both; float: top;">
                ...
                <form class="search_form" style="margin: 0 auto; width: 950px; height: 150px;"
